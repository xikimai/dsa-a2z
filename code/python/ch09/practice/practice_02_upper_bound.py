...
PROBLEM
-------
Given a sorted array of integers and a target value, find the upper
bound: the index of the first element that is strictly greater than
the target. If no element is greater than the target, return len(arr)
