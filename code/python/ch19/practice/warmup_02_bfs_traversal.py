...
source node, return the BFS traversal order starting from the source.
...
OUTPUT FORMAT
-------------
A list of node labels in BFS visit order.
...
HINT
----
Use a queue (collections.deque). Mark nodes as visited BEFORE enqueueing
to avoid duplicates. Sort neighbors before iterating.
