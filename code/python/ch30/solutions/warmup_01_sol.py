"""
Solution for Warmup 1: Range Sum Query (Segment Tree)
=====================================================
Chapter 30: Segment Trees & Range Queries

APPROACH
--------
Build a segment tree for sum queries. Process queries:
  - type 1 (sum): query the tree for range [l, r]
  - type 2 (update): point-update index l to val
