 ...
 *          index of the FIRST (leftmost) occurrence of the target,
 *          or -1 if not found.
 *
 * ALGORITHM: Modified binary search — when you find the target, don't
 *            stop! Keep searching LEFT for an earlier occurrence.
 *
 * EXAMPLES:
 *   solve(new int[]{1,2,2,2,3,4}, 2) = 1
 *   solve(new int[]{1,1,1,1,1}, 1)   = 0
 ...
 */
public class Warmup03FirstOccurrence {
