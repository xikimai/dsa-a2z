 ...
 */
public class Example02ConvexHullDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("CONVEX HULL: Andrew's Monotone Chain");
        System.out.println("=".repeat(60));

        int[][] points = {{0,0},{2,0},{2,2},{0,2},{1,1}};
        System.out.println("\nInput: (0,0),(2,0),(2,2),(0,2),(1,1)");

        int[][] hull = convexHull(points);
        System.out.print("Hull: ");
        for (int[] p : hull) System.out.print("(" + p[0] + "," + p[1] + ") ");
        System.out.println("\nPoint (1,1) is interior — not on hull!");
    }
}
